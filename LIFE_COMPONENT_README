# 实现自定义控件生命周期的自我管理 例子:[CountdownView](app\src\main\java\com\yan\anc\widget\CountdownView.kt)
...
## 编码[CountdownView](app\src\main\java\com\yan\anc\widget\CountdownView.kt)(kotlin)
