 ...
 */
class ModelFactory @Inject constructor(private val api: ANCApi) : ViewModelProvider.NewInstanceFactory() {

    @Suppress("UNCHECKED_CAST")
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        when (modelClass.simpleName){
             AndroidViewModel::class.java.simpleName ->return AndroidViewModel(api) as T
        }
        return null as T
    }
}